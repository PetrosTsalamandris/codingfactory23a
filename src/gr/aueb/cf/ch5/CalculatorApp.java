...
/**
 * Υλοποιει εναν απλο calculator
 * που παρεχει τις υπηρεσιες
 * add, sub, mul, div, mod
 * εμφανιζει ενα μενου προς τον χρηστη
 * με επιλογες, λαμβανει την τιμη της επιλογης
 * και στη συνεχεια δυο ακομα τιμες των num1, num2
 * τελικα εμφανιζει το αποτελεσμα
 */
